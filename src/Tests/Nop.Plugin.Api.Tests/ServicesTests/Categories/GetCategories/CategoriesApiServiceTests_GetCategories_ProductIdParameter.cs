...
namespace Nop.Plugin.Api.Tests.ServicesTests.Categories.GetCategories
{
    ...
    public class CategoriesApiServiceTests_GetCategories_ProductIdParameter
    {
        ...
        [Test]
        public void WhenCalledWithValidProductId_GivenCategoriesCollection_ShouldReturnOnlyTheCategoriesMappedToThisProduct()
        {
            // Arange
            int productId = 3;
        ...
        [Test]
        public void WhenCalledWithNegativeOrZeroProductId_GivenCategoriesCollection_ShouldReturnEmptyCollection()
        {
            // Arange
            int productId = 0;
        ...
        [TestCase(-1)]
        [TestCase(5465464)]
        public void WhenCalledWithProductIdThatDoesNotExistInTheMappings_GivenCategoriesCollection_ShouldReturnEmptyCollection(int productId)
        {
            // Arange
            // Act
            var categories = _categoryApiService.GetCategories(productId: productId);
